...
public class TokenAuthenticationService {
	...
	public Authentication getAuthentication(HttpServletRequest request) {
		...
		if (token != null) {
			...
			return claims != null
					? new UsernamePasswordAuthenticationToken(new LoggedUserDTO(Integer.valueOf(claims.getId()),
	...
	public Authentication getRefreshAuthetication(HttpServletRequest request) {
		...
		if (refreshToken != null) {
			...
			if (claims != null) {
				...
				LoggedUserDTO userDTO = new LoggedUserDTO(Integer.valueOf(claims.getId()), claims.getSubject(), idRole);
