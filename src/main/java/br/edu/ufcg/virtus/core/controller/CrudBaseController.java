...
import br.edu.ufcg.virtus.core.security.authorization.DeletePermission;
import br.edu.ufcg.virtus.core.security.authorization.InsertPermission;
import br.edu.ufcg.virtus.core.security.authorization.UpdatePermission;
import br.edu.ufcg.virtus.core.service.CrudService;
import br.edu.ufcg.virtus.core.util.NullAwareBeanUtils;
...
public abstract class CrudBaseController<M extends Model<T>, T extends Serializable, D extends ModelDTO> extends SearchBaseController<M, T, D> {
	...
	@PutMapping("/{id}")
	@UpdatePermission
	public ResponseEntity<D> update(HttpServletRequest request, @Valid @PathVariable T id, @RequestBody D modelDTO) throws BusinessException, Exception {
